...
<table class="table table-hover">
	<tr>
		...
		<th class="col-md-1">tanggal ex</th>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="tmb_brg_act.php" method="post">
					...
					<div class="form-group">
						<label>jenis</label>
						<input name="suplier" type="text" class="form-control" placeholder="jenis ..">
					</div>
					<div class="form-group">
						<label>satuan</label>
						<input name="satuan" type="text" class="form-control" placeholder="satuan per unit">
					</div>	
					<div class="form-group">
						<label>tanggal expaid</label>
						<input name="tanggal_ex" type="date" class="form-control" placeholder="tanggal_ex">
					</div>	
					<div class="form-group">
						<label>Jumlah</label>
