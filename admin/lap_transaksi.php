...
$pdf->Image('../logo/avmO5XQiIK_1488008002.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'PETROKIMIA GRESIK',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. ahmad yani',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'email: petrokimiagresik@gmail.com',0,'L');
