...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					$tgl_ex=$_POST['tanggal_ex'];
					$periksa=mysql_query("select * from barang where $tgl_sekarang <=$tgl_ex");
					while($q=mysql_fetch_array($periksa)){	
						if($q['tanggal_ex']<=$tgl_ex){			
							echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Stok  <a style='color:red'>". $q['nama']."</a> barang sudah waktunya untuk di ganti karena sudah melebihi batas waktu kadarluasa penggunaan !!</div>";	
						}
					}
					?>
				</div>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="transaksi.php"><span class="glyphicon glyphicon-briefcase"></span>  permintaan dan pemakaian p3k</a></li>        												
